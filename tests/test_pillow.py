...
@pytest.fixture
def setup_data() -> PillowTestImageData:
...
def test_pillow_draw_match_reference(setup_data: PillowTestImageData) -> None:
    """
...
def test_pillow_count_pixels_single(setup_data: PillowTestImageData) -> None:
    """
...
def test_pillow_drawloss_single(setup_data: PillowTestImageData) -> None:
    """
